...
export default function CreateTaskModal() {
  ...
  const [selectedMember, setSelectedMember] = useState<MemberOfHome | null>(null);
  ...
  const handleCancel = () => {
    Alert.alert('Cancelar', '¿Estás seguro de que quieres cancelar? Se perderán los cambios.', [
      {
        text: 'No',
        style: 'cancel'
      },
    ...
    return (
      <SafeAreaView style={styles.container}>
        <View style={styles.errorContainer}>
          ...
          <Text style={styles.errorText}>No hay hogar seleccionado. Regresa y selecciona un hogar primero.</Text>
          <TouchableOpacity
      ...
      >
        ...
        >
          ...
          <View style={styles.houseInfo}>
            <Text style={styles.houseInfoText}>
              📍 Creando tarea para: <Text style={styles.houseName}>{currentHome.name}</Text>
            </Text>
          </View>
          ...
          <View style={styles.row}>
            <View style={styles.halfSection}>
              ...
              >
                <Text style={styles.dateTimeText}>{selectedDate.toLocaleDateString('es-ES')}</Text>
              </TouchableOpacity>
            </View>
          ...
          <View style={styles.section}>
            ...
            <View style={styles.memberAssignment}>
              ...
              />
              <TouchableOpacity
                style={[styles.addButton, !selectedMember && styles.addButtonDisabled]}
                onPress={addMember}
            ...
            {errors.assignedMembers && <Text style={styles.errorText}>{errors.assignedMembers}</Text>}
              ...
              <View style={styles.assignedContainer}>
                ...
                <View style={styles.assignedList}>
                  {assignedMembers.map(memberId => (
                    ...
                    >
                      <Text style={styles.assignedChipText}>{getMemberName(memberId)}</Text>
                      <TouchableOpacity
        ...
        <View style={styles.buttonContainer}>
          ...
          <TouchableOpacity
            ...
            disabled={isLoading}
          >
            <Text style={styles.createButtonText}>{isLoading ? 'Creando...' : 'Crear Tarea'}</Text>
          </TouchableOpacity>
        </View>
