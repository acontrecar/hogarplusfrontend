...
import { AgendaSection, CalendarEvent, HouseTask, Task } from '../../../infraestructure/interfaces/calendar/calendar';
...
export default function CalendarScreen() {
  ...
  const renderHeader = (date?: any) => {
    ...
    return (
      ...
      >
        <Text style={styles.headerDate}>{date?.toString ? date.toString('MMMM yyyy') : 'Calendario'}</Text>
  ...
  const renderItem = ({ item }: { item: Task }) => <HouseTaskItem task={item} />;
