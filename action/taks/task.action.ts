...
export const urgyTaskAction = async (homeId: string): Promise<GlobalApiResponse<UrgencyTask> | null> => {
  return handleApiCall(() => hogarPlusApi.get<GlobalApiResponse<UrgencyTask>>(`/task/${homeId}/urgyTasks`));
};
